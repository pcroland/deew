...
with open('dev_scripts/readme_template_en.md', encoding='utf-8') as fl:
    readme_en = fl.read()

with open('dev_scripts/readme_template_hu.md', encoding='utf-8') as fl:
    readme_hu = fl.read()

with open('dev_scripts/header.md', encoding='utf-8') as fl:
    header = fl.read()

with open('dev_scripts/description_en.txt', encoding='utf-8') as fl:
    description_en = fl.read()

with open('dev_scripts/description_hu.txt', encoding='utf-8') as fl:
    description_hu = fl.read()

with open('dev_scripts/examples_en.txt', encoding='utf-8') as fl:
    examples_en = fl.read()

with open('dev_scripts/examples_hu.txt', encoding='utf-8') as fl:
    examples_hu = fl.read()
